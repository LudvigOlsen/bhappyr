...
##  Pick form / structure of sentence                                       ####
  ...
  gathered_form_collections <- c(forms, song_forms, fingers_forms)

  form <- sample(gathered_form_collections,1)

##  .................. #< 546a2cbe5424c33798a23e3addb07563 ># ..................
##  Convert form to sentence                                                ####

  sentence <- fill_in_form(form)
...
### Add uppercase first letters                                             ####
  ...
  # Uppercase first letter after dot and a white space
